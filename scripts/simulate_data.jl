...
# David Merrell
#
# Code for generating (reference graph, true graph, time series) tuples.
# As used in the simulation study for SSPS.
...
export generate_random_digraph, modify_and_simulate, save_dataset, save_graph, julia_main 
