...
\title[Reconstructing Signaling Pathways]{Reconstructing Signaling Pathways with Probabilistic Programming}
\author[Sample \textit{et~al}]{David Merrell\,$^{1,*}$, Anthony Gitter\,$^{2}$ and Co-Author\,$^2$\footnote{to whom correspondence should be addressed}}
\address{$^{1}$Department of Computer Sciences, University of Wisconsin--Madison\\
$^{2}$Morgridge Institutes of Research, Madison WI}
...
\section{Contact:} \href{dmerrell@cs.wisc.edu}{name@bio.com}
\end{abstract}
